...
from mya2a.config.currency import CurrencyAgentConfig
from mya2a.utils import create_chat_model
...
class CurrencyAgent:
    ...
    def __init__(self, config: CurrencyAgentConfig):

        self.model = create_chat_model(config.genai)
